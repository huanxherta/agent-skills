...
| [html-rendering](#html-rendering) | HTML 页面渲染与截图 | [`creative/html-rendering/`](creative/html-rendering/) |
...
<details>
<summary><b>html-rendering</b></summary>

使用 Playwright 生成样式化 HTML 页面并捕获截图。支持浅色主题、粉彩美学和终端风格设计。

- 禁止纯黑/深灰背景，优先使用暖白、粉彩、奶油色
- 提供三套配色方案：粉彩梦幻、暖白、幽灵终端（按需）
- 完整工作流：生成 HTML → Playwright 截图 → QQ 发送

→ [完整文档](creative/html-rendering/SKILL.md)
</details>
